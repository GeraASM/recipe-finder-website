...
export function Healthy() {
    return (
        <section className="pt-600 px-400 text-center relative">
            <img className="block absolute bottom-0 left-0 w-fill max-h-[530px]" src={"/assets/images/pattern-squiggle-1.svg"} alt="Patter" />
            ...
            <figure className="mt-500 lg:min-h-[530px] rounded-8 relative">
                <img className="w-full h-full rounded-8" src="/assets/images/image-home-hero-small.webp" alt="Home hero" />
